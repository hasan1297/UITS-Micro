...
<html lang="en">
  <head>
    ...
    <title>Teacher's Contact Information</title>
  </head>
  <body>
        <!-- css first -->
    <script>0</script>
    ...
    <nav class="Pnavbar mb-5">
      <ul>
        ...
        <li><a class="active" href="adTContactTable.php">Contact</a></li>
    ...
    <div class="body" style="max-width: 1400px;">
        ...
        <h3>Teacher's Contact Information Table</h3>
