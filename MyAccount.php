        ...
        <form action="" method="post">
          <div style="max-width: 900px;">
            <div class="container my-4">
              <?php
              if($teacher){
                echo '<h5 class="h5 mb-3">All my trips in this month:</h5>';
              }
              if($driver){
                echo '<h5 class="h5 mb-3">All my passengers in this month:</h5>';
              }
              ?>
              <table class="table" id="myTable">
                ...
                <tbody>
                  ...
                  <?php
                  if($teacher){
                    $sql = "SELECT * FROM `bookmicro` WHERE `loginIdT` = '{$_SESSION['loginID']}' AND `date` BETWEEN '$FDofTmonth' AND '$LDofTmonth'";
        ...
        <div class="container my-4">
          ...
          <?php
            ...
            if($teacher){
              ...
              // Total Trip at Noon
              $sql = "SELECT * FROM `bookmicro` WHERE `loginIdT` = {$_SESSION['loginID']} AND `date` BETWEEN '$FDofTmonth' AND '$LDofTmonth' AND `time` = 'Noon' ";
              $result = mysqli_query($conn,$sql);
              $num = mysqli_num_rows($result);
              echo '<b>Total Trip at Noon:<span style="color: red">'.$num.'</span></b><br>';
              // Total Trip at Evening
              $sql = "SELECT * FROM `bookmicro` WHERE `loginIdT` = {$_SESSION['loginID']} AND `date` BETWEEN '$FDofTmonth' AND '$LDofTmonth' AND `time` = 'Evening' ";
              $result = mysqli_query($conn,$sql);
              $num = mysqli_num_rows($result);
