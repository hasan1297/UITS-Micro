...
<?php
  if($_SERVER["REQUEST_METHOD"] == "POST"){
    if(isset($_POST['delete'])){
      $sql = "DELETE FROM `bookmicro` WHERE `busNo` = '{$_SESSION['busNo']}' AND `weekName` LIKE 'wednesday' AND `time` LIKE '{$_SESSION['shift']}' ";
    ...
    <div class="week">
      <nav class="Pnavbar">
        <ul>
          ...
          <li><a class="active" href="P_wednesday.php">Wednesday</a></li>
          <li><a href="P_thursday.php">Thursday</a></li>
        ...
        <div class="container my-4">
          ...
          <table class="table" id="myTable">
            ...
            <tbody>
              <!-- php MySQL query -->
              <?php
                $sql = "SELECT * FROM `bookmicro` WHERE `busNo` = '{$_SESSION['busNo']}' AND `weekName` LIKE 'wednesday' AND `time` LIKE '{$_SESSION['shift']}' ";
                $result = mysqli_query($conn,$sql);
